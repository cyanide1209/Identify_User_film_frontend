...
export function Terminal() {
  ...
  }, [contentRef, terminalRef]) // Removed unnecessary dependency: history

  return (
    <div
      ref={terminalRef}
      className="bg-black text-white p-4 h-screen w-screen overflow-hidden flex flex-col"
      style={{ fontFamily: "'Share Tech Mono', monospace" }}
    >
      <div className="flex-1 relative">
        <div ref={contentRef} className="absolute bottom-0 left-0 right-0 transition-transform duration-300 ease-out">
